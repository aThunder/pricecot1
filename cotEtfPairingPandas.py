...
class spCOT():
    ...
    def __init__(self):
        ...
        self.diskEngine = create_engine('sqlite:///allCotSymbols.db')
        self.recentList =[]
    ...
    def innerJoin1(self,criteria1):
        ...
        self.intoPandasJoin1 = pd.read_sql_query("SELECT comboCOT.NAME,"
                                                 ...
                                                 " SymbolsDataWeekly.SYMBOL,"
                                                 " SymbolsDataWeekly.CLOSE,"
                                                 " SymbolsDataWeekly.VOL, "
                                                 " SymbolsDataWeekly.DATE "
                                                 " FROM comboCOT "
                                                 "INNER JOIN SymbolsDataWeekly "
                                                 "ON comboCOT.ID_NAMEKEY =  SymbolsDataWeekly.ID_NAMEKEY "
                                                 "AND comboCOT.DATE = SymbolsDataWeekly.DATE "
                                                 "WHERE comboCOT.DATE > '2015-12-15'"
                                                 "AND NAME LIKE '{0}'"
                                                 "ORDER BY SymbolsDataWeekly.DATE asc".format(self.criteria1),
                                                 self.diskEngine)
